...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.btn_receiveBrowse = QtWidgets.QPushButton(self.tab)
        self.btn_receiveBrowse.setObjectName("btn_receiveBrowse")
        self.gridLayout_4.addWidget(self.btn_receiveBrowse, 0, 2, 1, 1)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.btn_receiveBrowse.setText(_translate("MainWindow", "Browse"))
